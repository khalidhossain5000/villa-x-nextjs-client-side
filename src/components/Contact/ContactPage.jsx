        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
            ...
            <p className="text-xl md:text-2xl max-w-2xl mx-auto text-gray-600 dark:text-gray-400 leading-relaxed">
              Whether you have a question about a booking or want to list your
              villa, our team is ready to help 24/7.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          {[
            {
              ...
              desc: "Issues with the app or website?",
              color: "blue",
            },
            {
              title: "Booking Inquiry",
              desc: "Need help with a specific reservation?",
              color: "orange",
            },
            {
              title: "Host Partnership",
              desc: "Want to grow your rental business?",
              color: "green",
            },
          ].map((item, i) => (
            <motion.div
            ...
            >
              ...
              <button className="text-[#f98d00] font-semibold hover:underline">
                Chat with an expert →
              </button>
            </motion.div>
          ))}
          ...
          <div className="grid lg:grid-cols-2 gap-16">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid md:grid-cols-2 gap-5">
                  <input
                    ...
                    className="w-full px-6 py-4 rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 focus:ring-2 focus:ring-[#f98d00] outline-none transition-all"
                  />
                  <input
                    required
                    type="email"
                ...
                <motion.button
                  whileHover={{
                    scale: 1.02,
                    boxShadow: "0 20px 25px -5px rgb(249 141 0 / 0.3)",
                  }}
                  whileTap={{ scale: 0.95 }}
                  type="submit"
            ...
            >
              <iframe
                ...
                allowFullScreen
                loading="lazy"
                className="grayscale contrast-125 dark:invert"
              />
            </motion.div>
          </div>
        </div>
          ...
          >
            {stats.map((stat, i) => (
              <motion.div key={i} variants={fadeInUp} className="space-y-2">
                <div className="text-4xl mb-4 flex justify-center opacity-80">
                  {stat.icon}
                </div>
                <div className="text-4xl md:text-5xl font-black">
                  {stat.value}
                </div>
                <div className="text-sm md:text-base font-medium opacity-90 uppercase tracking-widest">
                  {stat.label}
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-24 px-4 bg-gray-50 dark:bg-gray-900/50">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            >
              <div className="text-[#f98d00] text-3xl mb-4 flex justify-center">
                {card.icon}
              </div>
        ...
        <div className="max-w-5xl mx-auto bg-gray-900 dark:bg-[#f98d00] rounded-[3rem] p-12 md:p-20 text-center relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 leading-tight">
              ...
              <span className="text-[#f98d00] dark:text-gray-900">
                dream getaway?
              </span>
            </h2>
