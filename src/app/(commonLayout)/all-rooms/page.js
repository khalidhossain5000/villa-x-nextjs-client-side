...
<div
  ...
  />
    ...
    <div
      ...
      style={{
        background: "radial-gradient(ellipse 80% 60% at 50% 0%, rgba(3,0,250, 0.25), transparent 70%), #000000",
      }}
    />
...
<div className="relative z-50">
      ...
      <div className='pb-12'>
        <PageSubTitle className={'text-xl lg:text-2xl 2xl:text-3xl pt-3 pb-4'}>Filter By Category </PageSubTitle>
