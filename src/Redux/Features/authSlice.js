...
export const createUser = createAsyncThunk(
  ...
  async ({ email, password, name }) => {
    ...
    const result = await axios.post(
      "https://villla-x-nextjs-server-side.vercel.app/api/auth/register",
      {
        fullName: name,
        email,
        userRole: "guest",
...
//     console.log(
//       res,
//       "this is res, this is result from google sign in inside authslice",
//       result,
//     );
//     // user info save to db end here
...
export const googleSignIn = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      ...
      //call new API
      const result = await axios.post(
        "https://villla-x-nextjs-server-side.vercel.app/api/auth/social-login",
        userData
      );
...
//signout user
export const signOutUser = createAsyncThunk("authSlice/signOut", async () => {
  return signOut(auth);
});
